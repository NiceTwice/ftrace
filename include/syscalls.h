/*
** nums_syscalls.c for epitech in /home/chapui_s/rendu/
**
** Made by chapui_s
** Login   <chapui_s@epitech.eu>
**
** Started on  Mon May  4 22:21:54 2015 chapui_s
** Last update Sun Apr 10 21:33:15 2016 Pierre Debruyne
*/
...
static t_syscalls	g_syscalls[] =
{
  ...
  { 78, "getdents", 1, 3, INT, UNSIGNED_INT,
    ...
    0, 0 },
  { 79, "getcwd", 1, 2, CHAR_P, SIZE_T, 0, 0,
    0, 0, 0 },
  ...
  { 129, "rt_sigqueueinfo", 0, 6, 0, 0, 0, 0, 0, 0, 0 },
  ...
  { 296, "pwritev", 1, 4, SSIZE_T, INT,
    CONST_STRUCT_IOVEC_P, INT, OFF_T,
    0, 0 },
  { 297, "rt_tgsigqueueinfo", 0, 6, 0, 0, 0, 0, 0, 0, 0 },
  ...
  { 299, "recvmmsg", 1, 5, INT, INT,
    ...
    STRUCT_TIMESPEC_P, 0 },
  { 300, "fanotify_init", 1, 3, INT, UNSIGNED_INT,
    UNSIGNED_INT, INT, 0,
    0, 0 },
  { 301, "fanotify_mark", 1, 6, INT, INT,
    UNSIGNED_INT, INT, CONST_CHAR_P,
    U64, U64 },
  { 302, "prlimit64", 0, 6, 0, 0, 0, 0, 0, 0, 0 },
  { 303, "name_to_handle_at", 1, 5, INT, INT,
    CONST_CHAR_P_, STRUCT_FILE_HANDLE, INT_P_,
    INT, 0 },
  { 304, "open_by_handle_at", 1, 3, INT, INT,
    STRUCT_FILE_HANDLE, INT, 0,
    0, 0 },
